...
Built with Nuxt, Vue, Naive UI, TypeScript, Chart.js, and Pinia on the frontend; Django REST Framework and SimpleJWT on the backend. Live at calcura.org.$desc$,
    'Retirement scenario planner that shows how savings, spending, and investment choices compound across a working lifetime.',
    null,
    2024,
    'https://github.com/schir2/calcura',
    'https://calcura.org',
    true,
    null
)

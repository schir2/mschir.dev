...
<template>
  <div>
    <p class="text-xs font-mono text-amber-400 mb-6 uppercase tracking-widest">
      Variant B — Stacked (image separate, title below)
    </p>
    ...
    <article class="flex flex-col gap-6">
      ...
      <header class="flex flex-col gap-4">
        ...
        <!-- Metadata: logo + company + year -->
        <div class="flex items-center gap-3">
          <div style="width:24px;height:24px;flex-shrink:0;overflow:hidden;border-radius:4px;background:white;">
            <img
              :src="fixture.logoUrl"
              :alt="fixture.company"
          ...
          <div class="flex items-center gap-2 text-sm">
            <span class="font-semibold text-surface-200">{{ fixture.company }}</span>
            <span class="text-surface-600">·</span>
            <span class="text-surface-400">{{ fixture.year }}</span>
          </div>
        </div>

...
async function syncFeatured(articleId: string) {
  if (isFeatured.value) {
    const {error} = await supabase
        ...
        .upsert(
            {
              id: featuredArticleId.value ?? undefined,
              article_id: articleId,
              featured_reason: featuredReason.value?.trim() || null
            },
        ...
        <div class="flex gap-3 items-center flex-wrap">
            ...
            >
              <template #footer>
                <div class="p-2 border-t flex gap-2">
                  <p-input-text v-model="newCategoryName" placeholder="New category…" size="small" class="flex-1"
          ...
          <div class="flex flex-col gap-1 w-72">
            ...
            >
              <template #footer>
                <div class="p-2 border-t flex gap-2">
                  <p-input-text v-model="newTagName" placeholder="New tag…" size="small" class="flex-1"
          ...
          <div class="flex flex-col gap-1 w-44">
            ...
            >
              <template #footer>
                <div class="p-2 border-t flex gap-2">
                  <p-input-text v-model="newSeriesTitle" placeholder="New series…" size="small" class="flex-1"
